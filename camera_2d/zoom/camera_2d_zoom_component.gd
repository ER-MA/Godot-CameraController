...
@export_range(0.1, 1.0, 0.1, "suffix:倍率") var min_zoom: float = 0.7 ## 摄像机的缩放步长
@export_range(1.0, 5.0, 0.1, "suffix:倍率") var max_zoom: float = 3 ## 摄像机的缩放步长
@export_range(1.0, 10.0, 0.1) var deceleration_speed: float = 5.0 ## 摄像机的插值移动速度
@export_range(1.0, 1000.0, 1.0, "suffix:倍率/s") var smoothing_speed: float = 0.1 ## 摄像机的平滑移动速度
